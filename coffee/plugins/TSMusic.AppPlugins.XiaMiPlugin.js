...
(function() {
  ...
  if ((_ref = TSMusic.AppPlugins) == null) {
    TSMusic.AppPlugins = {};
  }

  TSMusic.AppPlugins.XiaMiPlugin = (function(_super) {
    __extends(XiaMiPlugin, _super);

    XiaMiPlugin.type = "app.xiami";
    ...
    function XiaMiPlugin(name) {
      ...
      this.lyric_url = "";
      this.div = document.getElementById("app-xiami-div");
      this.button = document.getElementById("browse-app-xiami");
      this.music_xiami = document.getElementById("music-app-xiami");
      this.submit_xiami = document.getElementById("submit-app-xiami");
